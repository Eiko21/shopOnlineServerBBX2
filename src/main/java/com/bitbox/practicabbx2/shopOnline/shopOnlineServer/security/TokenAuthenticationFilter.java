...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Value("${shopOnlineServerBBX.auth.accessTokenCookieName}")
    private String accessTokenCookieName;

    @Value("${shopOnlineServerBBX.auth.refreshTokenCookieName}")
    private String refreshTokenCookieName;

    @Autowired
    private ITokenProviderService tokenProvider;
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
                ...
                UserDetails userDetails = userDTODetailtsService.loadUserByUsername(username);
